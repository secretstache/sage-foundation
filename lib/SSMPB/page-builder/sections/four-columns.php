...
echo '<section' . SSMPB\section_id_classes() . $style . '>';
  ...
  if ( have_rows( 'four_column_components' ) ) {
    ...
    echo '<div class="grid-container">';
      ...
      echo '<div class="grid-x grid-margin-x main has-4-cols align-center align-' . $alignment . '"' . $maybe_set_equalizer . '>';
      ...
      while ( have_rows( 'four_column_components' ) ) {
        ...
        echo '<div class="cell small-11 medium-6 large-' . $grid_array[$pluck] . ' col-' . $i . '"' . $maybe_set_equalizer_watch . '>';
